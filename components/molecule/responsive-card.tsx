...
const ResponsiveCard = React.forwardRef<HTMLDivElement, ResponsiveCardProps>(
    ({
        ...
        const variantClasses = {
            ...
            purple: 'bg-purple-900/20 border border-purple-800/40',
        };
        ...
        return (
            <div
                ...
                className={cn(
                    ...
                    sizeClasses[size],
                    withHover && variant === 'glass' ? 'transition-all hover:backdrop-blur-lg hover:bg-white/10 hover:shadow-lg' : '',
                    withHover && variant !== 'glass' ? 'transition-all hover:-translate-y-1 hover:shadow-lg' : '',
                    className
                )}
                {...props}
            >
...
>(({ className, children, ...props }, ref) => (
    <div
        ref={ref}
        className={cn('flex items-center pt-3 sm:pt-4 border-t border-gray-800 mt-3 sm:mt-4', className)}
        {...props}
    >
        {children}
    </div>
